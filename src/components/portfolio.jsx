          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">Here are some of my projects.</p>
                  ...
                  <div className="row">
                    <div className="col-sm-8">
                      <h2 className="w-title">
                        NineWest.com{" "}
                        <a
                          href="https://rishabhtg209.github.io/NINE_WEST/"
                          target="_blank"
                        >
                          <img src={redirect} width={20}></img>
                        </a>
                    ...
                    <div className="col-sm-4">
                      <div className="w-like">
                        <a
                          href="https://github.com/RishabhTG209/NINE_WEST"
                          target="_blank"
                        >
                          <img src={git_logo} width={30}></img>
                        </a>
                  ...
                  <div className="row">
                    <div className="col-sm-8">
                      <h2 className="w-title">
                        Paperfry.com{" "}
                        <a
                          href="https://pepperfry-project-akshayjagtap1111.vercel.app"
                          target="_blank"
                        >
                          <img src={redirect} width={20}></img>
                        </a>
                    ...
                    <div className="col-sm-4">
                      <div className="w-like">
                        <a
                          href="https://github.com/sumit7195/pepperfry-project"
                          target="_blank"
                        >
                          <img src={git_logo} width={30}></img>
                        </a>
                  ...
                  <div className="row">
                    <div className="col-sm-8">
                      <h2 className="w-title">
                        Weather App{" "}
                        <a
                          href="https://wether-app-akshayjagtap1111.vercel.app/"
                          target="_blank"
                        >
                          <img src={redirect} width={20}></img>
                        </a>
                    ...
                    <div className="col-sm-4">
                      <div className="w-like">
                        <a
                          href="https://github.com/akshayjagtap1111/recipe_app"
                          target="_blank"
                        >
                          <img src={git_logo} width={30}></img>
                        </a>
                  ...
                  <div className="row">
                    <div className="col-sm-8">
                      <h2 className="w-title">
                        Recipe App{" "}
                        <a
                          href="https://recipe-app-akshayjagtap1111.vercel.app"
                          target="_blank"
                        >
                          <img src={redirect} width={20}></img>
                        </a>
